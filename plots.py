...
def create_reliability_plot():
    ...
    #plt.plot(x, gen_y(reliability(3,5),x),label='3 out of 5',marker="*")
    #plt.plot(x, gen_y(reliability(4,7),x),label='3 out of 5',marker="*")
    #plt.plot(x, gen_y(reliability(5,9),x),label='3 out of 5',marker="*")
    #plt.plot(x, gen_y(reliability(6,11),x),label='7 out of 15',marker="*")
    plt.axvline(x=math.log(2)/FAILURE_RATE, color='k', linestyle='--')
